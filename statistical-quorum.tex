...
We present the app in Section~\ref{sec:peermind} and use it for evaluating statistical quorum in
Section~\ref{sec:evaluation}.

\todo[inline]{Should we explicitly list our contributions again?}

\todo[inline]{Repeat the structure of the rest of the paper?}
...
% repeat references from "There have been many improvements proposed to this basic form and various analysis made."?

% voting auditing

% delegation as way to increase legitimacy
...
% describe why 0.90% is a reasnable statistical quorum and how to determine one for your community
