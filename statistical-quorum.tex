...
Even if voting turnout has reached legally required quorum, it is still a question how to evaluate if
the turnout is high enough to find results legitimate.
...
\begin{table*}
  ...
  \begin{tabular}{l r r r r r r r}
    ...
    \midrule
    Brexit & 17,410,742 & $51.9\%$ & 16,141,241 & $48.1\%$ & 46,500,001 & $72.2\%$ & \\
    Presidential elections & 62,984,825 & $48.9\%$ & 65,853,516 & $51.1\%$ & 250,055,734 & $51.5\%$ & \\
  \end{tabular}
  \caption{Votes cast in Brexit, a 2016 referendum for United Kingdom's withdrawal from the European Union,
  and 2016 USA presidential elections, popular vote. Simplified to only two options and without invalid votes.}\label{tab:example}
\end{table*}
