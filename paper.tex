...
\todo[inline]{Are we discarding abstentions too much here? If we have 5 people and each of them is computed 0.2 of abstention
through delegation, while the rest 0.8 is a vote, then we normalize 0.8 to 1.0 for all of them and simply discard 0.2
of abstention. But otherwise those 0.2 of abstentions would count together towards 1.0. But probably this is not a
problem because the quorum is still the same: those 5 people have participated through delegation in voting. Only
if somebody has not participated through delegation in voting we care if they might participated in abstentions
through voting. To maximize delegated participation.}
...
\todo[inline]{$x = x_v / x_w$ does not really produce the same result as computing with 0.50 as ratio to begin
with. Why?}
